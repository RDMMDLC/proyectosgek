...
{"name":"SRD_DataCompressor","status":true,"description":"Allows developers to drastically reduce the file sizes of data files; helps protect data files from being reopened.","parameters":{"Compress Data?":"true","Read from Compression":"true"}}
];
